const TelegramBot = require("node-telegram-bot-api"),
    ...
    host = "0.0.0.0",
    externalUrl = process.env.CUSTOM_ENV_VARIABLE || "https://bot-for-expense-app.herokuapp.com",
    token = process.env.TOKEN,
    bot = new TelegramBot(token, {webHook: {port: port, host: host}});
bot.setWebHook(externalUrl + ':443/bot' + token);

let loginSF = process.env.SALESFORCE_LOGIN;
let passwordSF = process.env.SALESFORCE_PASSWORD;
